 ...
 if(isset($_POST['submitlogin']))
  {
   ...
   $friend=$_POST['friend'];
    $name=$_POST['name'];
   $sql="SELECT * FROM student,teacher_information where teacher_information.question1='$food' AND teacher_information.question2='$friend' AND teacher_information.question3='$name' AND teacher_information.student_id=student.student_id ;"; 
...
echo'<meta content="10;forgot.php" http-equiv="refresh" />';
}
}
//mysql_close($conn);
?>
