  ...
  <div id="topbar" class="clear"> 
    ...
    <nav>
      <ul>
		...
		<li><a href="Ilogin.html">Instructor Login</a></li>
      ...
      <div class="group btmspace-30"> 
        ...
        <div id="forgot" class="tab-pane">
            <form action="index.html" class="form-signin">
                ...
                <input type="text"  required="required" placeholder="please give your answer" class="form-control" />
				<p class="text-muted text-center btn-block btn btn-primary btn-rect">what is your best friend name ?</p>
                <input type="text"  required="required" placeholder="please give your answer" class="form-control" />
				<p class="text-muted text-center btn-block btn btn-primary btn-rect">how many brothers do you have?</p>
                <input type="text"  required="required" placeholder="please give your answer" class="form-control" />
                <br />
