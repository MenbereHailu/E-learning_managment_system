  ...
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="aboutus.php">About us</a>
         <!-- <ul>
 ...
 if(isset($_POST['submitlogin']))
  {
   ...
   $friend=$_POST['friend'];
    $name=$_POST['name'];
   $sql="SELECT * FROM teacher,teacher_information where teacher_information.question1='$food' AND teacher_information.question2='$friend' AND teacher_information.question3='$name' AND teacher_information.teacher_id=teacher.teacher_id ;"; 
...
echo'<meta content="10;Ilogin.php" http-equiv="refresh" />';
...
echo'<meta content="10;iforgot.php" http-equiv="refresh" />';
}
}
//mysql_close($conn);
?>
	...
	<div class="text-center">
        <ul class="list-inline">
            <li><a  href="Ilogin.php" >Login</a></li>
            <li><a  href="iforgot.php" >Forgot Password</a></li>
